...
[^4]: A related issue is in some of the causal-inference literature [e.g., @neyman1990OnTheApplication, @lin2013agnostic], the authors have used a finite-population framework where the sample is the population. In this series, this will not be our approach. Rather, I am always assuming our sample is a representative subset of a superpopulation, as is typical in my field of psychology.
