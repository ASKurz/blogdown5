...
In this post, we'll be borrowing data from @wilson2017internet, *Internet-accessed sexually transmitted infection (e-STI) testing and results service: A randomised, single-blind, controlled trial*. Wilson and colleagues were open-science champions and made their primary data available as supporting information in their `S1Data.xls` file, which you can download by clicking this: [https://doi.org/10.1371/journal.pmed.1002479.s001](https://doi.org/10.1371/journal.pmed.1002479.s001). `r emo::ji("warning")` For this next code block to work on your computer, you will need to first download that `S1Data.xls` file, and then save that file in a `data` subfolder in your working directory.
