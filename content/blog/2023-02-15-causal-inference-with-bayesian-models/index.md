...
Notice that unlike what we’ve done before, we added a `row` index. This will help is join our `nd` data to the `fitted()` output, below. Speaking of which, here’s the ATE.
